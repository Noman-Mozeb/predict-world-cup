...
# Global Teams & Base Weights Data Frame
...
def run_poisson_engine(team_A, team_B, sims=5000):
    """Executes full algorithmic evaluation of match outcomes including extra time."""
    strength_A = TEAMS_DB[TEAMS_DB['Team'] == team_A]['Strength'].values[0]
    strength_B = TEAMS_DB[TEAMS_DB['Team'] == team_B]['Strength'].values[0]
